...
pub struct BottomLevelAccelerationStructure {
    ...
    pub(crate) buffer_refs: Mutex<FxHashMap<(vk::Buffer, usize), BlasBufferRef>>,
...
impl BottomLevelAccelerationStructure {
    pub(crate) unsafe fn new(
        ...
        let mut geometries = Vec::default();
        let mut build_ranges = Vec::default();
                    ...
                    .map(|geo| {
                        ...
                        tris.triangles =
                            vk::AccelerationStructureGeometryTrianglesDataKHR::builder()
                                ...
                                .vertex_data({
                                    let mut addr = geo.vertex_data.internal().device_address_const(
                                        &ctx.device,
                                ...
                                .index_data({
                                    let mut addr = geo.index_data.internal().device_address_const(
                                        &ctx.device,
        ...
        Ok(BottomLevelAccelerationStructure {
            geometries,
            build_ranges,
            buffer_refs: Mutex::new(buffer_refs),
            buffer,

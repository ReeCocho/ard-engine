...
use crate::{
    camera::{CameraFroxels, CameraUbo},
    factory::{
    ...
    lighting::{PointLight, RawLight, RawPointLight},
    material::{MaterialInner, MaterialInstance, PipelineType},
    mesh::{Mesh, MeshInner, ObjectBounds, VertexLayout},
    shader_constants::{FRAMES_IN_FLIGHT, FROXEL_TABLE_DIMS, MAX_LIGHTS_PER_FROXEL},
...
const CAMERA_FROXELS_BINDING: u32 = 1;

const LIGHT_CLUSTERING_LIGHTS_BINDING: u32 = 0;
const LIGHT_CLUSTERING_CLUSTERS_BINDING: u32 = 1;
const LIGHT_CLUSTERING_CAMERA_BINDING: u32 = 2;
const LIGHT_CLUSTERING_FROXELS_BINDING: u32 = 3;
        ...
        let camera_layout = DescriptorSetLayout::new(
            ...
            DescriptorSetLayoutCreateInfo {
                bindings: vec![
                    ...
                    // Froxels
                    DescriptorBinding {
                        binding: CAMERA_FROXELS_BINDING,
...
impl RenderData {
    ...
    pub fn update_light_cluster_set(&mut self, global: &GlobalRenderData, frame: usize) {
    ...
    /// Prepares light clustering by reseting the lights table.
